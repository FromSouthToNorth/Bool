    ...
    <div class="ui container">
      ...
      <div class="ui bottom attached segment teal">
        <div class="ui labeled button m-margin-tb-tiny" >
          ...
          <div class="ui basic left pointing label" >2
          </div>
        </div>
      </div>
        ...
        <div class="ui padded vertical segment stackable m-padded-large" >
          <div class="ui middle aligned mobile reversed stackable grid">
              ...
              <div class="ui grid">
                <div class="row">
                  <div class="six wide column">
                    <div class="ui mini horizontal link list">
                      <div class="item">
                        <img
                             src="https://images.unsplash.com/photo-1592786999269-63f5b72a2553?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=100&q=100"
                             alt="" class="ui avatar image">
                        <div class="content"><a href="#"  class="header" >小王八</a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="sixteen wide column m-font-color">
                    ...
                    <span class="m-margin-lr-small">
                                                <i class="eye icon"></i><span >66</span>
                                            </span>
                    <span class="m-margin-lr-small">
                                                <i class="comment outline icon"></i><span ></span>
                                            </span>
                  </div>
                </div>
                <div class="row">
            ...
            <div class="ui five wide column">
              <a href="#" >
                <img
                     src="https://images.unsplash.com/photo-1592786999269-63f5b72a2553?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=700&q=350"
